...
Twitter.prototype.postDirectMessage = function ( params, error, success) {
    var path =  '/direct_messages/events/new.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doPost(url, params, error, success);
};


Twitter.prototype.getDirectMessagesEventList = function (params, error, success) {
    var path =  '/direct_messages/events/list.json' + this.buildQS(params);
    var url = this.baseUrl + path;
    this.doRequest(url, error, success);
};
